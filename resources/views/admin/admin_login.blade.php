...
<body class="">
	...
	<div class="wrapper">
		<div class="section-authentication-cover">
            ...
            <div class="col-12">
                <label for="inputEmailAddress" class="form-label">Email/Name</label>
                <input type="text" name="login" class="form-control @error('login') is-invalid @enderror" id="login" placeholder="test@example.com">
                @error('login')
